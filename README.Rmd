...
`yfR` is the second and backwards-incompatible version of [BatchGetSymbols](https://CRAN.R-project.org/package=BatchGetSymbols), a R package for large-scale download of financial data from Yahoo Finance. It make it easier to fetch tidy data of stock prices from the repository. 

## Features

- Fetchs daily/weekly/monthly/annual stock prices and returns from yahoo finance;
...
Collections are just a bundle of ticker pre-organized in the package. For example, collection `SP500` represents the current composition of the Ibovspa index. 
